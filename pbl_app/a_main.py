...
class MainPage(Screen):
    ...
    def __init__(self,**kwargs):    #Initializes the page/screen
        ...
        for i in range(20):    ##Displays the details one by one, for now just showing random details, but later will fix it
            ...
            btn_img = Image(source = f"hostel{random.randint(0,9)}.jpeg", size_hint_x = None, width = 150)
    ...
    def hostel_func(self, instance):    #Function to display all the hostels of required area.
        ...
        for i in range(20):    ##Displays the details one by one, for now just showing random details, but later will fix it
            ...
            ttext = random.choice(["Boys", "Girls", "All"])
            btn_layout = BoxLayout(size_hint_y = None, height = 220)
            btn_img = btn_img = Image(source = f"hostel{random.randint(0,9)}.jpeg", size_hint_x = None, width = 150)
            btn_layout.add_widget(btn_img)
            in_btn_layout = BoxLayout(orientation = "vertical")
            host_name = LBLabel(text = f"Hostel {htext}")
            area_name = LBLabel(text = f"Area :{self.textinput.text}")
    ...
    def flat_func(self, instance):    #Function to display all the flats of required area
        ...
        for i in range(20):    ##Displays the details one by one, for now just showing random details, but later will fix it
            ...
            ttext = random.choice(["Boys", "Girls", "All"])
            btn_layout = BoxLayout(size_hint_y = None, height = 220)
            btn_img = btn_img = Image(source = f"flat{random.randint(0,9)}.jpeg", size_hint_x = None, width = 150)
            btn_layout.add_widget(btn_img)
            in_btn_layout = BoxLayout(orientation = "vertical")
    ...
    def roommate_func(self, instance):    ##Function to display all the user in a specified area, will work on filtering preference.
        ...
        for i in range(20):    ##Displays the details one by one, for now just showing random details, but later will fix it
            ...
            btn_layout = BoxLayout(size_hint_y = None, height = 220)
            btn_img = Image(source = f"user{random.randint(0,9)}.jpg", size_hint_x = None, width = 150)
            btn_layout.add_widget(btn_img)
            in_btn_layout = BoxLayout(orientation = "vertical")
...
class ToolPage(Screen):
    ...
    def __init__(self,**kwargs):    #Initialization of the screen/page.
        ...
        logo_image = Image(source = "logo.jpg", allow_stretch = True, keep_ratio = False)
...
class ProfilePage(Screen):
    def __init__(self,**kwargs):
        ...
        logo = Image(source = "logo.jpg", allow_stretch = True, keep_ratio = False)
...
class JoinTeamPage(Screen):
    def __init__(self, **kwargs):
        ...
        for i in range(mtext):
            ...
            user_img = Image(source = f"user{random.randint(0,9)}.jpg", size_hint_x = None, width = 150)
...
class SavedPage(Screen):
    ...
    def flat_func(self, instance):
        ...
        for i in range(20):
            ...
            ttext = random.choice(["Boys", "Girls", "All"])
            btn_layout = BoxLayout(size_hint_y = None, height = 200)
            btn_img = Image(source = f"flat{random.randint(0,9)}.jpeg", size_hint_x = None, width = 150)
            btn_layout.add_widget(btn_img)
            in_btn_layout = BoxLayout(orientation = "vertical")
            host_name = LBLabel(text = f"Flat {htext}")
            area_name = LBLabel(text = f"Area :{self.textinput.text}")
...
class EditPrefPage(Screen):
    def __init__(self, **kwargs):
        ...
        for i in pre_list:
            ...
            pre_btn = ToggleButton(text = f"{i}", size_hint_y = 0.4, background_color = get_color_from_hex('#1FF2CC'))
...
class HostelPage(Screen):
    def __init__(self, **kwargs):
        ...
        atext = random.choice(["Akurdi", "Pimpri", "Lonavala", "Pune", "Vashi", "Nerul", "Ulwe", "Mumbai"])
        btn_layout = BoxLayout(size_hint_y = None, height = 220)
        btn_img = Image(source = f"hostel{random.randint(0,9)}.jpeg", size_hint_x = None, width = 220)
        btn_layout.add_widget(btn_img)
        in_btn_layout = BoxLayout(orientation = "vertical")
        host_name = LBLabel(text = f"Hostel {htext}")
        area_name = LBLabel(text = f"Area :{atext}")
...
class FlatPage(Screen):
    def __init__(self, **kwargs):
        ...
        atext = random.choice(["Akurdi", "Pimpri", "Lonavala", "Pune", "Vashi", "Nerul", "Ulwe", "Mumbai"])
        btn_layout = BoxLayout(size_hint_y = None, height = 220)
        btn_img = Image(source = f"flat{random.randint(0,9)}.jpeg", size_hint_x = None, width = 220)
        btn_layout.add_widget(btn_img)
        in_btn_layout = BoxLayout(orientation = "vertical")
        host_name = LBLabel(text = f"Flat {htext}")
        area_name = LBLabel(text = f"Area :{atext}")
...
class RoomPage(Screen):
    def __init__(self, **kwargs):
        ...
        top2 = BoxLayout(size_hint_y = 0.2)
        logo = Image(source = f"user{random.randint(0,9)}.jpg", size_hint_x = None, width = 150)
        right_layout = BoxLayout(orientation='vertical')
...
class ChatBotPage(Screen):
    def __init__(self, **kwargs):
        ...
        btn_layout = BoxLayout(size_hint_y = None, height = 300)
        user_type = LGLabel(text = f"{user}", size_hint_x = 0.2)
        user_text = LGLabel(text = f"{answer}", font_size = 30)
    ...
    def send(self,instance):
        ...
        btn_layout.add_widget(btn_img)
        user_text = LBLabel(text = f"{self.textinput.text}", font_size = 30)
        ...
        btn_layout = BoxLayout(size_hint_y = None, height = 300)
        btn_img = LGLabel(text = f"Chat Bot:", size_hint_x = 0.2)
        btn_layout.add_widget(btn_img)
        self.bot_text = LGLabel(text = "Thinking of a suitable reply...", font_size = 30)
